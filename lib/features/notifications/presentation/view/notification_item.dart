...
class NotificationItem extends StatelessWidget {
  ...
  NotificationViewModel viewModel;
   NotificationItem({super.key,required this.notification,required this.viewModel});
    ...
    return Row(
      ...
      Expanded(
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text(notification.title,style: AppTextStyles.title(fontSize: 19.sp,fontWeight: FontWeight.w600),),
            SizedBox(height: 5.h,),
            Text(notification.body,style: AppTextStyles.subtitle(fontSize:16.sp,fontWeight: FontWeight.w500),maxLines: 5,overflow: TextOverflow.ellipsis,),
