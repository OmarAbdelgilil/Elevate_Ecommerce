...
class _ApiManager implements ApiManager {
  ...
  Future<HomeResponse?> getHomePage() async {
    ...
    try {
      _value =
          _result.data == null ? null : HomeResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<BestSellerProductResponse?> getAllBestSellerProducts() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<BestSellerProductResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  @override
  Future<GetAllOccasionsResponse?> getAllOccasions() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GetAllOccasionsResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>?>(_options);
    late GetAllOccasionsResponse? _value;
    try {
      _value = _result.data == null
          ? null
          : GetAllOccasionsResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<CartResponse?> updateCartProductQuantity(
    String productId,
    UpdateCartProductQuantityRequest req,
  ) async {
    final _extra = <String, dynamic>{'requiresToken': true};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<UserResponse?> getProfile(String authorization) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'Authorization': authorization};
    _headers.removeWhere((k, v) => v == null);
  ...
  @override
  Future<UserResponse?> updateProfileData(UpdateProfileRequest request) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
